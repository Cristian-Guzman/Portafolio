...
import { SeccionDiv, SeccionServicios } from '../styles/services.style'
...
function Services() {
    return (
        <React.Fragment>
            ...
            <Contenedor>
                <Titulo align="center" fontWeight="500" padding="2rem 0 0 0" fontSize="3rem">Services</Titulo>
                <SeccionDiv display="grid">
                    <SeccionServicios>
